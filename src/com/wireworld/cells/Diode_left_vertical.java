...
public class Diode_left_vertical extends GridView {


    public Diode_left_vertical(BasicBoard initialBoard, int size, Stage primaryStage) {
        super(initialBoard, size, primaryStage);
    }

    public static void drawDiodeLeftVertical(Board simulationToDraw, int x, int y, GraphicsContext g) {
